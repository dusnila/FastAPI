...
from app.exceptions import IncorrectEmailorPasswordException, UserAlredyExistsException
...
async def register_user( user_data: SUserAuth):
    existing_user = await UsersService.find_one_or_not(email=user_data.email)
    if existing_user:
